        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium text-foreground">
              Leading ESG Innovation in Waste Management
            </span>
          </div>
          ...
          >
            We transform cigarette waste into sustainable products, creating measurable environmental impact while
            helping corporations achieve their ESG goals.
          </p>
          ...
          >
            ...
            <div className="text-center p-5 sm:p-6 rounded-2xl glass hover-lift">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground font-medium">Tons CO₂ Avoided</p>
            </div>
            <div className="text-center p-5 sm:p-6 rounded-2xl glass hover-lift">
